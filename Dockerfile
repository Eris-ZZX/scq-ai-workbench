...
RUN mkdir -p /app/storage/ai-resources/uploads \
  && chown -R nextjs:nodejs /app/storage

USER nextjs
EXPOSE 3000
# Use node directly to avoid shell shebang/CRLF issues on Windows-authored scripts.
ENTRYPOINT ["node", "scripts/start-with-db.mjs"]
CMD ["npm", "run", "start"]
